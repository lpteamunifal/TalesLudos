...
<body class="container-fluid">
	...
	<div class="row">
		...
		<div id="frame-div" class="col-8 frame-fixer">
			<div class="tab">
				<button class="tablinks" onclick="openTab(event, 'Jornada')" id="defaultOpen">Jornada</button>
				<button id="CenaTab" class="tablinks" onclick="openTab(event, 'Cena')">Cena</button>
				<button id="DesafioTab" class="tablinks" onclick="openTab(event, 'Desafio')">Desafio</button>
			</div>
			@if(Auth::check())
				<button class="btn right"><i class="fa fa-save"></i> Salvar Projeto</button>
			@endif
      
			<button class="btn right" onclick=""><i class="fa fa-play"></i> Visualizar</button>
